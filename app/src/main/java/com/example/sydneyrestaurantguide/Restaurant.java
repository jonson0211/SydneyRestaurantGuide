...
public class Restaurant {
    ...
    public static ArrayList<Restaurant> getRestaurants() {
        ...
        restaurants.add(new Restaurant("Sokyo", 2, "Level G, The Darling The Star/80 Pyrmont Street, Pyrmont", "9.5", "Japanese, Fine Dining", 150, "Sashimi Platter", "A staple in Sydney, Sokyo serves Japanese cuisine that is unrivalled to none in Sydney. Looking for somewhere fancy for a special occasion, and don't mind a higher price point? Look no further.", "Pyrmont"));
        ...
        restaurants.add(new Restaurant("Bare Witness", 6, "30 Shoreline Dr, Rhodes", "8.9", "Modern Australian, Brunch, Cafe, Casual Dining", 28, "Chicken & Waffles","This place is for the brunch enthusiasts. Bare Witness offers a stunning river view in Rhodes, and some of the most aesthetically appealing (for you Instagram foodies out there) and best tasting brunch food in Sydney. ", "Rhodes"));
        restaurants.add(new Restaurant("It's Time for Thai", 7, "2/309 Anzac Parade, Kingsford ", "8.7", "Thai, Malaysian, Casual Dining", 15, "Thai Seafood Laksa", "This Thai restaurant provides great value for money, it's not wonder why it's so popular among students attending UNSW. You will find a great variety in meal choices, and not a single one disappoints. ", "Kingsford"));
